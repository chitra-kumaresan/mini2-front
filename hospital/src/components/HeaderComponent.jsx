...
<a class="navbar-brand" href="#"><h2>Hospital Management Application</h2></a>
{!isAuth && (
<button type="button" onClick={()=>navigator("/reg")} className="btn btn-success btn-lg" >Register</button> )}
